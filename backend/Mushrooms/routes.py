...
@router.get("/", response_model=list[MushroomSchema], status_code=200, tags=["Mushroom"])
@inject
...
@router.get("/{mushroom_id}", response_model=MushroomSchema, status_code=200, tags=["Mushroom"])
@inject
...
@router.post("/", response_model=MushroomSchema, status_code=201, tags=["Mushroom"])
@inject
